...
# FUNCTION that shows Product Catalog
...
# FUNCTION for Validating Stock Availability Before Adding to Cart and Adding Items to Cart
...
def add_to_cart():
    while True:
        ...
        if items in products:
            ...
            # Out of Stock (If item is sold out during the session)
            ...
            # The option to add another item without going back to the main menu
...
# View Cart Function - Viewing the Cart and Calculating Totals
...
def view_cart():
    ...
    # How to get the subtotal and calculations
...
# Checkout Function - Calculating Discount and Taxes Along with the Grand Total of the Cart
...
def checkout():
    ...
    # Implementation of Discount - 12% Discount if Cart Total is > 7000
...
# Receipt Function - Header, Store Name, and Date and Time added
